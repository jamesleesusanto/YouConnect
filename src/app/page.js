  ...
  return (
    <div>
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        {/* Vertical YOUDEMONIA text */}
        <div className="hidden lg:flex absolute right-8 top-1/2 -translate-y-1/2 flex-col items-center gap-1">
          {"YOUDEMONIA".split("").map((letter, i) => (
            <span key={i} className="text-sm font-bold text-primary/20 tracking-widest">{letter}</span>
          ))}
        </div>
        {/* Vertical purple line */}
        <div className="hidden sm:block absolute left-8 top-1/4 bottom-1/4 w-1 bg-primary rounded-full" />
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-border/40 shadow-lg p-10 sm:p-14">
            ...
            <div className="flex items-center gap-4 mb-2">
              ...
              <div className="flex gap-2">
                <a href="https://linkedin.com/company/youdemonia" target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-foreground/20 transition">
                ...
                <a href="https://instagram.com/youdemonia" target="_blank" rel="noopener noreferrer" className="w-7 h-7 rounded-full bg-foreground/10 flex items-center justify-center hover:bg-foreground/20 transition">
            ...
            <div className="space-y-5 text-[15px] leading-relaxed text-foreground">
              <p>
                ...
                <a href="#" className="text-primary hover:underline">501(c)(3) Not For Profit Organization</a>,
                aimed at promoting opportunity awareness. Through our{" "}
                <Link href="/opportunities" className="text-primary hover:underline">YouConnect Platform</Link>,
                ...
                <a href="#" className="text-primary hover:underline">leverage for success</a>.
              </p>
            </div>
