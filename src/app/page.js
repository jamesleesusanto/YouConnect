...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="relative py-20 sm:py-28 overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-border/40 shadow-lg p-10 sm:p-14">
            ...
            <p className="text-primary font-bold italic text-lg sm:text-xl mt-8 text-center line-through decoration-red-400 decoration-2">
      ...
      {/* Stats with animated count-up numbers */}
      <section className="border-y border-border/40 bg-white/50 relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(124,58,237,0.04),transparent_50%),radial-gradient(circle_at_70%_50%,rgba(124,58,237,0.04),transparent_50%)]" />
          ...
          <div className="grid grid-cols-3 gap-8">
            {[
              ...
              <div key={s.label} className="text-center group">
                ...
                <p className="text-4xl font-bold text-foreground"><AnimatedNumber target={s.value} suffix={s.suffix} /></p>
